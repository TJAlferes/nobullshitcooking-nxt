...
import { actionTypes, IState } from '../../../src/store/plannerView/types';
...
describe('plannerView reducer', () => {
  it('handles actions of type CLICK_DAY on a day', () => {
    ...
    const reducer = plannerViewReducer(state, {type: CLICK_DAY, day: 1})
  ...
  it('handles actions of type LOAD', () => {
    const state =   {...initialState};
    const reducer = plannerViewReducer(state, {type: LOAD, planName: "My Plan", planData});
