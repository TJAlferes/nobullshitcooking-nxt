...
import { authStaffLoginSaga, authStaffLogoutSaga, authUserRegisterSaga, authUserVerifySaga, authUserLoginSaga, authUserLogoutSaga } from '../auth/sagas';
import { actionTypes } from '../auth/types';

const { AUTH_STAFF_LOGIN, AUTH_STAFF_LOGOUT, AUTH_USER_REGISTER, AUTH_USER_VERIFY, AUTH_USER_LOGIN, AUTH_USER_LOGOUT } = actionTypes;
