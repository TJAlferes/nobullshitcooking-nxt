...
import { chatConnectSaga, chatDisconnectSaga, chatJoinRoomSaga, chatSendMessageSaga, chatSendPrivateMessageSaga } from '../chat/sagas';
import { actionTypes as chatActionTypes } from '../chat/types';

const { AUTH_USER_LOGOUT } = authActionTypes;
const { CHAT_CONNECT, CHAT_DISCONNECT, CHAT_JOIN_ROOM, CHAT_SEND_MESSAGE, CHAT_SEND_PRIVATE_MESSAGE } = chatActionTypes
