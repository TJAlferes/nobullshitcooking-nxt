...
export function Avatar({ authname, onSelectFile }: Props): JSX.Element {
  return (
    <div className="dashboard-avatar">
      <Link href={`/profile/${authname}`}><a className="dashboard-avatar__a">View Profile</a></Link>
      ...
      <input accept="image/*" className="dashboard-avatar__input" name="set-avatar" onChange={onSelectFile} type="file" />
    </div>
  );
}
